# Desafio: 5 Prompts para Recriar o Notion

> *Repositório oficial do Desafio Codecon: será que é possível recriar o Notion usando apenas 5 prompts de IA?*

## Sobre o Desafio

Inspirado no vídeo ["Dev Especialista vs Vibecoder"](https://www.youtube.com/watch?v=NnYLzGMk8Tg), este repositório documenta o desafio onde desenvolvedores tentaram recriar funcionalidades do Notion usando apenas **5 prompts** para IAs generativas.
...
3. Planeje sua estratégia de prompts
4. Desenvolva sua versão do Notion
5. Documente seu processo no README
...
2. **Contextualize**: Explique o objetivo final
3. **Itere**: Cada prompt deve construir sobre o anterior
4. **Peça estrutura**: Solicite organização de código e comentários
